...
func buildProjectFromForm(c echo.Context) *models.Project {
	project := &models.Project{
		...
		CompanyPAN:           strings.ToUpper(strings.TrimSpace(c.FormValue("company_pan"))),
		SignatoryName:        strings.TrimSpace(c.FormValue("signatory_name")),
		SignatoryDesignation: strings.TrimSpace(c.FormValue("signatory_designation")),
		SignatoryMobile:      strings.TrimSpace(c.FormValue("signatory_mobile")),
