...
func main() {
	...
	projectRoutes.Use(appmiddleware.RequireAuth(), appmiddleware.ProjectContext())
	{
		...
		projectRoutes.POST("/shipments/new/step3", handlers.ShipmentWizardQuantityStep)
		projectRoutes.POST("/shipments/new/step4", handlers.ShipmentWizardStep4)
		projectRoutes.POST("/shipments/new/step5", handlers.ShipmentWizardStep5)
		projectRoutes.POST("/shipments/new/back-to-step1", handlers.BackToStep1)
		projectRoutes.POST("/shipments/new/back-to-step2", handlers.BackToStep2)
		projectRoutes.POST("/shipments/new/back-to-step3", handlers.BackToStep3)
		projectRoutes.POST("/shipments/new/back-to-step4", handlers.BackToStep4)
		...
		projectRoutes.POST("/shipments/:gid/edit/step5", handlers.EditWizardStep5)
		projectRoutes.POST("/shipments/:gid/edit/back-to-step1", handlers.EditBackToStep1)
		projectRoutes.POST("/shipments/:gid/edit/back-to-step2", handlers.EditBackToStep2)
		projectRoutes.POST("/shipments/:gid/edit/back-to-step3", handlers.EditBackToStep3)
